<template>
  <DashboardLayout title="Game Providers">
    <div class="mx-auto max-w-[1600px] space-y-4 p-4 sm:p-6 lg:p-8">
      ...
      <AppHeader variant="b" />
      <UtilityBar />
      <HeroBanner :image="bannerB" alt="EURO 2024 promotional banner" />
      <QuickActions :actions="quickActions" />

      <div class="flex gap-4 pb-4">
        <CategorySidebar :items="sidebarCategories" v-model:active="activeCategory" class="themed-surface rounded-xl border" />
...
import { sidebarCategories, providers, bottomNavB, quickActions, bannerB } from '@/data/games'
